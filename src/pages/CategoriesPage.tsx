      ...
      <div className="relative z-[2] min-h-screen pt-24 pb-16">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explore articles organized by topics. Click on any category to view
            related posts.
          </p>
        </motion.div>
        ...
        {!selectedCategory && (
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              Click on any category above to discover amazing content, or browse
              all posts on the homepage.
            </p>
